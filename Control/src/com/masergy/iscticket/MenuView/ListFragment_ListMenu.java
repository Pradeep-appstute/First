...
//	public static Integer[] images = { R.drawable.ic_tickets, R.drawable.ic_modifyservice, R.drawable.ic_dopplerim, R.drawable.ic_contactus, R.drawable.ic_logout };
	...
	public static final List<Integer> images_ticketsselected = new ArrayList<Integer>(Arrays.asList(new Integer[]{ R.drawable.ic_tickets_w, R.drawable.ic_modifyservice, R.drawable.ic_dopplerim, R.drawable.ic_contactus_w, R.drawable.ic_logout }));
	public static final List<Integer> images_modifyserviceselected = new ArrayList<Integer>(Arrays.asList(new Integer[]{ R.drawable.ic_tickets, R.drawable.ic_modifyservice_w, R.drawable.ic_dopplerim, R.drawable.ic_contactus_w, R.drawable.ic_logout }));
	public static final List<Integer> images_dopplerimselected = new ArrayList<Integer>(Arrays.asList(new Integer[]{ R.drawable.ic_tickets, R.drawable.ic_modifyservice, R.drawable.ic_dopplerim_w, R.drawable.ic_contactus_w, R.drawable.ic_logout }));
	public static final List<Integer> images_contactusselected = new ArrayList<Integer>(Arrays.asList(new Integer[]{ R.drawable.ic_tickets, R.drawable.ic_modifyservice, R.drawable.ic_dopplerim, R.drawable.ic_contactus, R.drawable.ic_logout }));
	public static final List<Integer> images_logoutselected = new ArrayList<Integer>(Arrays.asList(new Integer[]{ R.drawable.ic_tickets, R.drawable.ic_modifyservice, R.drawable.ic_dopplerim, R.drawable.ic_contactus_w, R.drawable.ic_logout_w }));
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
		...
		menuListImages.add(R.drawable.ic_contactus_w);
	...
	public void onListItemClick(ListView lv, View v, int position, long id) {
		...
		switch (position) {
		case 0:{
			menuListImages = images_ticketsselected;
	  		rowItems = new ArrayList<RowItem>();
	        for (int i = 0; i < menuListLabel.size(); i++) {
	             RowItem item = new RowItem(menuListImages.get(i), menuListLabel.get(i));
	             rowItems.add(item);
		...
		case 1:
		{
			menuListImages = images_modifyserviceselected;
	  		rowItems = new ArrayList<RowItem>();
	        for (int i = 0; i < menuListLabel.size(); i++) {
	             RowItem item = new RowItem(menuListImages.get(i), menuListLabel.get(i));
	             rowItems.add(item);
			...
			break;
		case 2:{
			menuListImages = images_dopplerimselected;
	  		rowItems = new ArrayList<RowItem>();
	        for (int i = 0; i < menuListLabel.size(); i++) {
	             RowItem item = new RowItem(menuListImages.get(i), menuListLabel.get(i));
	             rowItems.add(item);
			...
			break;
		case 3:{
			menuListImages = images_contactusselected;
	  		rowItems = new ArrayList<RowItem>();
	        for (int i = 0; i < menuListLabel.size(); i++) {
	             RowItem item = new RowItem(menuListImages.get(i), menuListLabel.get(i));
	             rowItems.add(item);
		...
		case 4:{
			...
			menuListImages = images_logoutselected;
	  		rowItems = new ArrayList<RowItem>();
	        for (int i = 0; i < menuListLabel.size(); i++) {
	             RowItem item = new RowItem(menuListImages.get(i), menuListLabel.get(i));
	             rowItems.add(item);
